export const dummyEvents = [
  ...
  //   lat: 51.53338604671945,
  //   lng: -0.15259403013781342,
  //   date: "2022-07-30",
  //   address: "24 Folders Lane",
  //   time: "19:00:00",
  ...
  //   lat: 51.48065383554675,
  //   lng: - 0.15476209864526883,
  //   date: "2022-07-30",
  //   time: "14:00:00",
  //   address: "24 Folders Lane",
  ...
  //   eventName: "Tai Chi",
  //   img: "https://media-cldnry.s-nbcnews.com/image/upload/newscms/2018_19/2423546/180507-better-tai-chi-se-1137a.jpg",
  //   eventTags: ["outdoors", "parking"],
  //   lat: 51.46621450484308,
  //   lng: - 0.09322230793365105,
  //   date: "2022-08-01",
  //   time: "07:00:00",
  //   address: "24 Folders Lane",
  //   eventDescription:
  ...
  //   eventTags: ["kids", "outdoors"],
  //   lat: 51.535772084729444,
  //   lng: - 0.03985446775013427,
  //   date: "2022-08-02",
  //   time: "11:00:00",
  //   address: "24 Folders Lane",
  //   eventDescription:
  ...
  //   lat: 51.515434882549535,
  //   lng: - 0.08688487691185844,
  //   date: "2022-08-02",
  //   time: "18:00:00",
  //   address: "24 Folders Lane",
  //   eventeventDescription:
  //     "Come and join us for this free event!",
  //   mainDescription: "Come to our legendary Summer Ball, music, dancing and live entertainment. Black tie dresscode",
  //   email: "wrufc@email.com",
  //   rating: 3,
  // },
  // {
  ...
  //   lat: 51.52726476857551,
  //   lng: - 0.04002124225070778,
  //   date: "2022-08-05",
  //   time: "14:00:00",
  //   address: "24 Folders Lane",
  //   eventDescription:
  //     "Peppa Playgroup",
  //   mainDescription: "Come and meet our mobile petting zoo, Harry the Horse, Gary the Goat, Edward Emu, Larry Lemur, Shaun the Sheep and Peppa piglets, free face-painting too",
  //   email: "peppaplaygroud@email.com",
  //   rating: 3,
  // },
  // {
  //   eventId: 17,
  ...
  //   lat: 51.51169759571224,
  //   lng: - 0.09428018289825682,
  //   date: "2022-08-08",
  //   time: "14:00:00",
  //   address: "24 Folders Lane",
  //   eventDescription:
  //     "Tastes from around the world",
  //   mainDescription: "Come and try free samples from our popular Street Food Festival.",
  //   email: "deli_belly@email.co.uk",
  //   rating: 3,
  // },
  // {
  //   eventId: 18,
  ...
  //   eventTags: ["outdoors", "kids", "dog friendly"],
  //   lat: 51.4926849255875,
  //   lng: - 0.112205144701503,
  //   date: "2022-07-30",
  //   time: "14:00:00",
  //   address: "24 Folders Lane",
  //   eventDescription:
  //     "West Wessex Brass Band",
  //   mainDescription: "Come and hear our award-winning brass band go through their repertoire. Free lessons beforehand for those interested in playing!",
  //   email: "wwbb@yahoo.com",
  //   rating: 2,
  // },
  // {
  //   eventId: 19,
  ...
  //   img: "hhttps://loveincorporated.blob.core.windows.net/contentimages/gallery/db9c6601-8f92-401a-85b5-f9ccdf6a1e16-25387f98-6fcc-4947-ba18-5a89fe764135-17834069_mancave.jpg",
  //   eventTags: ["parking", "kids"],
  //   lat: 51.50186191500844,
  //   lng: - 0.1423945540543387,
  //   date: "2022-08-02",
  //   time: "18:00:00",
  //   address: "24 Folders Lane",
  //   eventDescription:
  //     "Panic Escapes",
  //   mainDescription: "Come and sample our addictive Panic Room experience. Problem-solving under pressure, teamwork and lots of fun!",
  //   email: "panicescltd@icloud.com",
  //   rating: 3,
  // },
  // {
  //   eventId: 20,
  ...
  //   eventTags: ["18+", "parking"],
  //   lat: 51.52629665936915,
  //   lng: - 0.09651274318797254,
  //   date: "2022-08-02",
  //   time: "19:00:00",
  //   address: "24 Folders Lane",
  //   eventDescription:
  //     "Medicine Bar",
  //   mainDescription: "Come and enjoy our free Acid Jazz night. Starting at 7pm we have three great artists performing.",
  //   email: "medbar@email.com",
  //   rating: 4,
  // },
  // {
  //   eventId: 21,
  ...
  //   lat: 51.48432414332409,
  //   lng: - 0.1216014151573745,
  //   date: "2022-07-30",
  //   time: "18:00:00",
  //   address: "24 Folders Lane",
  //   eventDescription:
  //     "Live Lounge",
  //   mainDescription: "Come and join our free annual Klassix Karaoke event, free entry and top three singers get to go to the regional finals.",
  //   email: "klassixent@email.com",
  //   rating: 1,
  // },
  // {
  //   eventId: 22,
  ...
  //   eventTags: ["18+", "parking"],
  //   lat: 51.499784591400285,
  //   lng: - 0.12349305900072409,
  //   date: "2022-07-30",
  //   time: "14:00:00",
  //   address: "24 Folders Lane",
  //   eventDescription:
  //     "D8 Night!",
  //   mainDescription: "Come to our popular singles night and get free registration for our fantastic dating service.",
